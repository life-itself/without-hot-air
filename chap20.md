...
[^u1]: <span style="color:#a3540f;font-weight:600;">*EV efficiency and lithium reserves.*</span> Most production EVs today use 15–20 kWh per 100 km — MacKay's early-prototype estimate held up well. World lithium reserves (economically extractable) have grown to about 28 million tonnes, up from the 9.5 million tons this chapter cites, with broader identified resources around 105 million tonnes — easing the scarcity concern this chapter raises. Sources: US DOE/EIA EV efficiency data, 2024; USGS, *Mineral Commodity Summaries 2024/2025* (Lithium).
